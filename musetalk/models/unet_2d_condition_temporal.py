...
from musetalk.models.temporal_blocks import UNetMidBlock3DCrossAttn

# from diffusers.models.unets.unet_3d_blocks import get_mid_block
...
def get_mid_block(
    ...
    elif mid_block_type == "UNetMidBlock3DCrossAttn":
        print("Using UNetMidBlock3DCrossAttn")
...
# copied from diffusers/models/unets/unet_2d_condition.py
@dataclass
